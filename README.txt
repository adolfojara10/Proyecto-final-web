...
a persistence unit "ProyectoFinalBancoPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ec/edu/ups/ppw/ProyectoFinalBanco/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "ProyectoFinalBanco/pom.xml":
...
artifact ("ProyectoFinalBanco.war") is already built. You can build
